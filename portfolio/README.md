...
`registry.json` is the portfolio decision and progress index. It records all 43 repositories. `batch-01.md` records shipped changes and rollback baselines. A proposed merge/archive is not complete merely because it was approved.
